...
export class MockDebugSession extends LoggingDebugSession {
	...
	protected async launchRequest(response: DebugProtocol.LaunchResponse, args: LaunchRequestArguments) {
		...
		this.sendEvent(new ProgressStartEvent("LAUNCH", "before-1"));
		await timeout(1000);
		this.sendEvent(new ProgressUpdateEvent("LAUNCH", "before-2"));
		await timeout(1000);
		this.sendErrorResponse(response, 1000, "some problem");
		this.sendEvent(new ProgressEndEvent("LAUNCH", "before-3"));
	}
